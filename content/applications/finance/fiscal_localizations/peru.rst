...
for taxpayers who need to transfer their products, except those under the *Single Simplified Regime*
(régimen único simplificado or RUS).
...
The *Carrier* delivery guide type justifies the transportation service by the driver (or carrier)
performs.
